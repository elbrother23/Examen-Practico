<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Master/PL/MasterPage.Master" AutoEventWireup="true" CodeBehind="ListaSolicitudes.aspx.cs" Inherits="ExamenMaritimaDominicana.Pages.Dashboard.PL.ListaSolicitudes" %>
        ...
        <ContentTemplate>
            <table width="100%">
                <tr>
                    <td>
                        <center>
<asp:Panel runat="server" GroupingText="Listado de Solicitudes" width="1200px">

                <table class="auto-style2">
                    <tr>
                        <td class="auto-style4">¿Buscar todas las solicitudes?</td>
                    ...
                    <tr>
                        <td class="auto-style4">Rango de Fecha:</td>
                        <td class="auto-style6">
                    ...
                    <tr>
                        <td class="auto-style4">Solicitudes Asignadas:</td>
                        <td class="auto-style6">
                            <asp:CheckBox ID="chkAsignadas" runat="server" Text="Asignadas" />
                        </td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        <td class="auto-style1" colspan="4">
                            <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true" PrintMode="ActiveX" ToolPanelView="None" Visible="False" />
                        </td>
                    </tr>
                </table>
